...
function ContactBox(props) {
  ...
  return (
    <div className="w-[400px] h-[150px] bg-transparent flex rounded-[30px] border-1 border-[#9f9e9eff] justify-around items-center p-0 max-[768px]:w-full max-[768px]:h-auto max-[768px]:flex-col max-[768px]:p-[20px] max-[768px]:gap-[15px]">
      ...
      <p className="text-[25px] m-auto max-[768px]:text-[18px] max-[768px]:mt-0 max-[768px]:text-center" style={{color:theme.color}}>
          {props.info}
      </p>
      </div>
    </div>
